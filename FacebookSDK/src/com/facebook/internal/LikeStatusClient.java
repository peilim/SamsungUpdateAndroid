...
/**
 * This class executes service calls to fetch like-state of objects from the
 * Facebook Application, if available.
 */
final class LikeStatusClient extends PlatformServiceClient {
	...
	LikeStatusClient(Context context, String applicationId, String objectId) {
		super(context, NativeProtocol.MESSAGE_GET_LIKE_STATUS_REQUEST,
