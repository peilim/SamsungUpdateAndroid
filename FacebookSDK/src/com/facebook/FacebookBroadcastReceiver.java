...
/**
 * This class implements a simple BroadcastReceiver designed to listen for
 * broadcast notifications from the Facebook app. At present, these
 * notifications consistent of success/failure notifications for photo upload
 * operations that happen in the background.
 *
 * Applications may subclass this class and register it in their
 * AndroidManifest.xml, listening on the
