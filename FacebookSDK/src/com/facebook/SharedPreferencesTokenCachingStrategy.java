...
public class SharedPreferencesTokenCachingStrategy extends TokenCachingStrategy {
	...
	public Bundle load() {
		...
		final Map<String, ?> allCachedEntries = cache.getAll();
	...
	private void deserializeKey(String key, Bundle bundle) throws JSONException {
		final String jsonString = cache.getString(key, "{}");
		...
		if (valueType.equals(TYPE_BOOLEAN)) {
			...
			try {
				...
				final Class<? extends Enum> enumClass = (Class<? extends Enum>) Class
						.forName(enumType);
				@SuppressWarnings("unchecked")
				final Enum<?> enumValue = Enum.valueOf(enumClass,
