...
public class UiLifecycleHelper {
	...
	private final PendingCallStore pendingFacebookDialogCallStore;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			final String callIdString = savedInstanceState
	...
	private boolean handleFacebookDialogActivityResult(int requestCode,
		...
		final FacebookDialog.PendingCall pendingCall = pendingFacebookDialogCallStore
	...
	private void cancelPendingAppCall(
		...
		if (facebookDialogCallback != null) {
			final Intent pendingIntent = pendingCall.getRequestIntent();
