...
public interface GraphObject {
	...
	final class Factory {
		...
		public static boolean hasSameId(GraphObject a, GraphObject b) {
			...
			final Object idB = b.getProperty("id");
		...
		private static <T extends GraphObject> T createGraphObjectProxy(
			...
			final GraphObjectProxy graphObjectProxy = new GraphObjectProxy(
					state, graphObjectClass);

			@SuppressWarnings("unchecked")
			final T graphObject = (T) Proxy.newProxyInstance(
		...
		private static Map<String, Object> createGraphObjectProxyForMap(
			...
			@SuppressWarnings("unchecked")
			final Map<String, Object> graphObject = (Map<String, Object>) Proxy
		...
		private static <T extends GraphObject> void verifyCanProxyClass(
			...
			for (final Method method : methods) {
				...
				final boolean hasPropertyNameOverride = method
		...
		static <U> U coerceValueToExpectedType(Object value,
			...
			if (GraphObject.class.isAssignableFrom(expectedType)) {
				...
				if (JSONObject.class.isAssignableFrom(valueType)) {
					...
					@SuppressWarnings("unchecked")
					final U result = (U) createGraphObjectProxy(
							graphObjectClass, (JSONObject) value);
					return result;
					...
					@SuppressWarnings("unchecked")
					final U result = (U) ((GraphObject) value)
				...
				final Type[] actualTypeArguments = expectedTypeAsParameterizedType
				...
				if (JSONArray.class.isAssignableFrom(valueType)) {
					...
					@SuppressWarnings("unchecked")
					final U result = (U) createList(jsonArray,
				...
				if (Double.class.isAssignableFrom(valueType)
					...
					@SuppressWarnings("unchecked")
					final U result = (U) String.format("%f", value);
					return result;
				} else if (Number.class.isAssignableFrom(valueType)) {
					@SuppressWarnings("unchecked")
					final U result = (U) String.format("%d", value);
					return result;
				}
		...
		private abstract static class ProxyBase<STATE> implements
			...
			protected final Object proxyObjectMethods(Object proxy,
				...
				if (methodName.equals(EQUALS_METHOD)) {
					...
					final InvocationHandler handler = Proxy
		...
		private final static class GraphObjectProxy extends
			...
			private final Object proxyGraphObjectMethods(Object proxy,
				...
				if (methodName.equals(CAST_METHOD)) {
					...
					final Object value = state.opt((String) args[0]);
				...
				if (createGraphObject != null
					...
					if (List.class.isAssignableFrom(value.getClass())) {
						...
						for (final Object obj : values) {
							final GraphObject graphObject = GraphObject.Factory
									.create();
			...
			private final Object proxyGraphObjectGettersAndSetters(
				...
				final String methodName = method.getName();
				final int parameterCount = method.getParameterTypes().length;
				final PropertyName propertyNameOverride = method
						.getAnnotation(PropertyName.class);

				final String key = propertyNameOverride != null ? propertyNameOverride
						.value()
				...
				if (parameterCount == 0) {
					...
					final Type genericReturnType = method
					...
					// class has been verified
					final CreateGraphObject createGraphObjectAnnotation = method
		...
		private final static class GraphObjectListImpl<T> extends
			...
			public T get(int location) {
				...
				final Object value = state.opt(location);

				// Class<?> expectedType = method.getReturnType();
				// Type genericType = method.getGenericReturnType();
				final T result = (T) coerceValueToExpectedType(value, itemType,
						null);
