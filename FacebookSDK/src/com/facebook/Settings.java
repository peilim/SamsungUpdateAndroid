...
public final class Settings {
	...
	/**
	 * Initialize SDK This function will be called once in the application, it
	 * is tried to be called as early as possible; This is the place to register
	 * broadcast listeners.
	 */
	public static synchronized void sdkInitialize(Context context) {
		...
		BoltsMeasurementEventListener.getInstance(context
	 ...
	 * {@link Settings#setIsDebugEnabled(boolean)} instead.
	 */
	@Deprecated
	...
	static void publishInstallAsync(final Context context,
	...
	static Response publishInstallAndWaitForResponse(final Context context,
		...
		try {
			...
			final AttributionIdentifiers identifiers = AttributionIdentifiers
			...
			final String lastResponseJSON = preferences
					.getString(jsonKey, null);
			...
			final String publishUrl = String.format(PUBLISH_ACTIVITY_PATH,
					applicationId);
			final Request publishRequest = Request.newPostRequest(null,
			...
			if (lastPing != 0) {
				...
				if (graphObject == null) {
					...
					|| (identifiers.getAndroidAdvertiserId() == null && identifiers
				...
				final Response publishResponse = publishRequest
						.executeAndWait();
	...
	public static String getAttributionId(ContentResolver contentResolver) {
		...
		try {
			...
			final String attributionId = c.getString(c
	...
	public static void setLimitEventAndDataUsage(Context context,
		...
		context.getSharedPreferences(APP_EVENT_PREFERENCES,
				...
				.putBoolean("limitEventUsage", limitEventUsage).apply();
	}
