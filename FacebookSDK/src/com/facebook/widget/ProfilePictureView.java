...
public class ProfilePictureView extends FrameLayout {
	...
	private void initialize(Context context) {
		...
		final LayoutParams imageLayout = new LayoutParams(
	...
	private void refreshImage(boolean force) {
		final boolean changed = updateImageQueryParameters();
	...
	private void setBlankProfilePicture() {
		if (customizedDefaultProfilePicture == null) {
			final int blankImageResource = isCropped() ? R.drawable.com_facebook_profile_picture_blank_square
	...
	private void sendImageRequest(boolean allowCachedResponse) {
		try {
			final ImageRequest.Builder requestBuilder = new ImageRequest.Builder(
					getContext(), ImageRequest.getProfilePictureUrl(profileId,
							queryWidth, queryHeight));

			final ImageRequest request = requestBuilder
	...
	private boolean updateImageQueryParameters() {
		...
		final int presetSize = getPresetSizeInPixels(false);
		...
		final boolean changed = (newWidthPx != queryWidth)
