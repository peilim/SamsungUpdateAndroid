...
public class LoginButton extends Button {
	...
	public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
		final Session session = sessionTracker.getSession();
		if (session != null) {
	...
	private void checkNuxSettings() {
		if (nuxMode == ToolTipMode.DISPLAY_ALWAYS) {
			final String nuxString = getResources().getString(
			...
			final AsyncTask<Void, Void, FetchedAppSettings> task = new AsyncTask<Void, Void, Utility.FetchedAppSettings>() {
				...
				protected FetchedAppSettings doInBackground(Void... params) {
					final FetchedAppSettings settings = Utility
							.queryAppSettings(appId, false);
					return settings;
				}
		...
		if (fetchUserInfo) {
			...
			if (currentSession != null) {
				if (currentSession != userInfoSession) {
					final Request request = Request.newMeRequest(
							currentSession, new Request.GraphUserCallback() {
								@Override
		...
		public void onClick(View v) {
			...
			if (openSession != null) {
				...
				if (confirmLogout) {
					...
					final String logout = getResources().getString(
				...
				if (currentSession == null
					...
					final Session session = new Session.Builder(context)
				...
				if (!currentSession.isOpened()) {
					...
					if (parentFragment != null) {
						...
						final Context baseContext = ((ContextWrapper) context)
								.getBaseContext();
