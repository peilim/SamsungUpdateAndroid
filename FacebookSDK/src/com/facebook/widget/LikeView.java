...
public class LikeView extends FrameLayout {
	...
	public enum AuxiliaryViewPosition {
		...
		static AuxiliaryViewPosition fromInt(int enumValue) {
			for (final AuxiliaryViewPosition auxViewPosition : values()) {
	...
	/**
	 * If your app does not use UiLifeCycleHelper, then you must call this
	 * method in the calling activity's onActivityResult method, to process any
	 * pending like actions, where tapping the button had resulted in the Like
	...
	public static boolean handleOnActivityResult(Context context,
		...
		return LikeActionController.handleOnActivityResult(context,
	...
	/**
	 * Sets the associated object for this LikeView. Can be changed during
	 * runtime.
	 * 
	 * @param objectId
	 *            Object Id
	...
	private void parseAttributes(AttributeSet attrs) {
		...
		objectId = Utility
				.coerceValueIfNullOrEmpty(
						a.getString(R.styleable.com_facebook_like_view_object_id),
						null);
		likeViewStyle = Style.fromInt(a.getInt(
				R.styleable.com_facebook_like_view_style,
		...
		foregroundColor = a.getColor(
				R.styleable.com_facebook_like_view_foreground_color,
				NO_FOREGROUND_COLOR);
	...
	// initialize() to ensure proper behavior
	private void initialize(Context context) {
		edgePadding = getResources().getDimensionPixelSize(
				R.dimen.com_facebook_likeview_edge_padding);
		...
		if (foregroundColor == NO_FOREGROUND_COLOR) {
			foregroundColor = getResources().getColor(
					R.color.com_facebook_likeview_text_color);
		}

		setBackgroundColor(Color.TRANSPARENT);

		containerView = new LinearLayout(context);
		final LayoutParams containerViewLayoutParams = new LayoutParams(
	...
	private void initializeLikeButton(Context context) {
		likeButton = new LikeButton(context,
				likeActionController != null ? likeActionController
						.isObjectLiked() : false);
		...
		final LinearLayout.LayoutParams buttonLayout = new LinearLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	private void initializeSocialSentenceView(Context context) {
		...
		socialSentenceView.setTextSize(
				...
				getResources().getDimension(
						R.dimen.com_facebook_likeview_text_size));
		socialSentenceView.setMaxLines(2);
		socialSentenceView.setTextColor(foregroundColor);
		socialSentenceView.setGravity(Gravity.CENTER);

		final LinearLayout.LayoutParams socialSentenceViewLayout = new LinearLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
	...
	private void initializeLikeCountView(Context context) {
		...
		final LinearLayout.LayoutParams likeCountViewLayout = new LinearLayout.LayoutParams(
				android.view.ViewGroup.LayoutParams.MATCH_PARENT,
				android.view.ViewGroup.LayoutParams.MATCH_PARENT);
	...
	private void setObjectIdForced(String newObjectId) {
		...
		LikeActionController.getControllerForObjectId(getContext(),
				newObjectId, creationCallback);
	}
	...
	private void tearDownObjectAssociations() {
		...
		// sure we aren't waiting anymore.
		// Otherwise when that controller is given back to the callback, it will
		// go and register a broadcast receiver
		// for it.
	...
	private void updateLayout() {
		...
		// specifications.
		final LayoutParams containerViewLayoutParams = (LayoutParams) containerView
				.getLayoutParams();
		final LinearLayout.LayoutParams buttonLayoutParams = (LinearLayout.LayoutParams) likeButton
				.getLayoutParams();
		final int viewGravity = horizontalAlignment == HorizontalAlignment.LEFT ? Gravity.LEFT
		...
		final LinearLayout.LayoutParams auxViewLayoutParams = (LinearLayout.LayoutParams) auxView
				.getLayoutParams();
	...
	private class LikeControllerBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (extras != null) {
				...
				final String broadcastObjectId = extras
