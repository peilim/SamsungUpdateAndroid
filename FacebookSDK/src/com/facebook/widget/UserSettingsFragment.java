...
public class UserSettingsFragment extends FacebookFragment {
	...
	private void fetchUserInfo() {
		...
		if (currentSession != null && currentSession.isOpened()) {
			if (currentSession != userInfoSession) {
				final Request request = Request.newMeRequest(currentSession,
	...
	private void updateUI() {
		...
		if (isSessionOpen()) {
			...
			if (user != null) {
				final ImageRequest request = getImageRequest();
				if (request != null) {
				...
				final Drawable noProfilePic = getResources().getDrawable(
			...
			final int textColor = getResources()
					.getColor(
