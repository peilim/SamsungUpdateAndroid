...
public class WebDialog extends Dialog {
	...
	public WebDialog(Context context, String action, Bundle parameters,
		...
		final Uri uri = Utility.buildUri(ServerProtocol.getDialogAuthority(),
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 */
		final int crossWidth = crossImageView.getDrawable().getIntrinsicWidth();
	...
	protected Bundle parseResponseUri(String urlString) {
		final Uri u = Uri.parse(urlString);

		final Bundle b = Utility.parseUrlQueryString(u.getQuery());
	...
	private void calculateSize() {
		...
		// web dialog
		final int width = metrics.widthPixels < metrics.heightPixels ? metrics.widthPixels
				: metrics.heightPixels;
		final int height = metrics.widthPixels < metrics.heightPixels ? metrics.heightPixels
				: metrics.widthPixels;
	...
	private class DialogWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			if (url.startsWith(WebDialog.this.expectedRedirectUrl)) {
				final Bundle values = parseResponseUri(url);
				...
				if (Utility.isNullOrEmpty(error)
					...
					final FacebookRequestError requestError = new FacebookRequestError(
	...
	private static class BuilderBase<CONCRETE extends BuilderBase<?>> {
		...
		protected BuilderBase(Context context, String action) {
			...
			if (activeSession != null && activeSession.isOpened()) {
				...
				final String applicationId = Utility
