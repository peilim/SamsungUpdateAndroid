...
/**
 * <p>
 * Basic implementation of a Fragment that uses a Session to perform Single Sign
 * On (SSO). This class is package private, and is not intended to be consumed
 * by external applications.
 * </p>
 *
 * <p>
 * The method {@link android.support.v4.app.Fragment#onActivityResult} is used
 * to manage the session information, so if you override it in a subclass, be
 * sure to call {@code super.onActivityResult}.
 * </p>
 *
 * <p>
...
class FacebookFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		sessionTracker = new SessionTracker(getActivity(),
				new DefaultSessionStatusCallback());
	}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		sessionTracker.getSession().onActivityResult(this.getActivity(),
	...
	private void openSession(String applicationId, List<String> permissions,
		...
		if (sessionTracker != null) {
			...
			if (currentSession == null || currentSession.getState().isClosed()) {
				final Session session = new Session.Builder(getActivity())
