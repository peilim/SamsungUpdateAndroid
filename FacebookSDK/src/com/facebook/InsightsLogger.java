...
public class InsightsLogger {
	...
	private InsightsLogger(Context context, String applicationId,
			Session session) {
	...
	public void logConversionPixel(String pixelId, double valueOfPixel) {
		...
		if (pixelId == null) {
			Logger.log(LoggingBehavior.DEVELOPER_ERRORS, "Insights",
					"pixelID cannot be null");
			return;
		}
		...
		appEventsLogger.logEvent(EVENT_NAME_LOG_CONVERSION_PIXEL, valueOfPixel,
				parameters);
